    ...
    <form action="{{  route('create-booking') }}" method="post" class="booking-container">
        ...
        <div class="booking-info">
            ...
            <label class="payment-option">
                ...
                <img src="{{ asset('clients/assets/images/booking/tich-hop-cong-thanh-toan-paypal.jpg') }}" alt="Office Payment">
                Thanh toán tại văn phòng
            </label>

            <label class="payment-option">
                <input type="radio" name="payment" value="paypal-payment" required>
                <img src="{{ asset('clients/assets/images/booking/tich-hop-cong-thanh-toan-paypal.jpg') }}" alt="PayPal">
                Thanh toán bằng PayPal
            </label>

            <label class="payment-option">
                <input type="radio" name="payment" value="momo-payment" required>
                <img src="{{ asset('clients/assets/images/booking/cong-thanh-toan-momo.jpg') }}" alt="MoMo">
        ...
        <div class="booking-summary">
            <div class="summary-section">
                ...
                <div class="order-coupon">
                    <input type="text" placeholder="Mã giảm giá" style="width: 70%">
