             ...
             <div class="row justify-content-between">
                 <div class="col-xl-5 col-lg-6" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                     <div class="footer-widget footer-text">
                         ...
                         <p>Chúng tôi thiết kế các hành trình riêng biệt theo sở thích của bạn, đảm bảo mỗi chuyến đi đều suôn sẻ và mang lại những trải nghiệm tuyệt vời mà ít người biết đến.</p>
                 ...
                 <div class="col-xl-5 col-lg-6" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                     ...
                     <div class="section-title counter-text-wrap mb-35">
                        ...
                        <p>Một địa điểm <span class="count-text plus" data-speed="3000" data-stop="34500">0</span> trải nghiệm phổ biến nhất mà bạn sẽ nhớ mãi.</p>
                    </div>
                 ...
                 <div class="col col-small" data-aos="fade-up" data-aos-delay="150" data-aos-duration="1500"
                     ...
                     <div class="footer-widget footer-links">
                        ...
                        <ul class="list-style-three">
                            ...
                            <li><a href="contact.html">Tour Thám Hiểm Động Vật Hoang Dã</a></li>
                        </ul>
             ...
             <div class="row">
                 <div class="col-lg-5">
                     <div class="copyright-text text-center text-lg-start">
                         <p>@Copy 2024 <a href="{{ route('home') }}">GoVietTour</a>, All rights reserved</p>
                     </div>
                 </div>
 ...
 <!-- Mirrored from webtendtheme.net/html/2024/ravelo/{{ route('home') }} by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 09:27:04 GMT -->
