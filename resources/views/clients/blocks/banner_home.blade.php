...
<section class="hero-area bgc-black pt-200 rpt-120 rel z-2">
    <div class="container-fluid">
        <h1 class="hero-title" data-aos="flip-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">Du lịch & Lữ hành</h1>
    ...
    <div class="container container-1400">
        <div class="search-filter-inner" data-aos="zoom-out-down" data-aos-duration="1500" data-aos-offset="50">
            ...
            <div class="filter-item clearfix">
                ...
                <input type="text" id="start_date" name="start_date" class="datetimpicker datetimpicker-custom" placeholder="Chọn ngày đi"readonly>
            </div>
            <div class="filter-item clearfix">
                <div class="icon"><i class="fal fa-calendar-alt"></i></div>
                <span class="title">Ngày kết thúc</span>
                <input type="text" id="start_date" name="end_date" class="datetimpicker datetimpicker-custom" placeholder="Chọn ngày về"readonly>
            </div>
