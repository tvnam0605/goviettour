            ...
            <div class="row" style="display: inline-block;width: 100%">
                <div class="tile_count">
                    ...
                    <div class="col-md-3 col-sm-4  tile_stats_count">
                        ...
                        <div class="count green"><i class="fa fa-sort-asc"></i> {{ $summary['totalUsers'] }}</div>
                    </div>
                    <div class="col-md-3 col-sm-4  tile_stats_count">
                        <span class="count_top"><i class="fa fa-user"></i> Tổng doanh thu</span>
                        <div class="count red">{{ isset($summary['totalAmount']) ? number_format($summary['totalAmount'], 0, ',', '.') : 0 }} vnđ</div>
                        <span class="sparkline_two" style="height: 160px;">
                            <canvas width="196" height="40" style="display: inline-block; width: 196px; height: 40px; vertical-align: top;"></canvas>
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="x_panel tile fixed_height_320 overflow_hidden">
                        ...
                        <div class="x_content">
                            <table class="" style="width:100%">
                                ...
                                <tr>
                                    <td>
                                        <canvas class="canvasDoughnut" height="50px" width="50px"
